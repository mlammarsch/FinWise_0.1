...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/register',       name: 'register',       component: RegisterView,  meta: { title: 'Registrieren' } },
  { path: '/tenant-select',  name: 'tenant-select',  component: TenantSelectView, meta: { title: 'Tenant wählen' } },
