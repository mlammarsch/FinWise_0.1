  ...
  <div class="flex justify-end w-full md:w-auto mt-2 md:mt-0">
    <div class="join flex items-center">
      ...
      <input
        ...
        type="text"
        placeholder="Suche..."
        class="input join-item rounded-l-full input-sm input-bordered border-1 border-base-300 text-center"
        @keyup="triggerSearch"
      />
      ...
      >
        <Icon v-if="btnLeftIcon" :icon="btnLeftIcon" class="mr-2" />
        {{ btnLeft }}
      </button>
      ...
      >
        <Icon v-if="btnMiddleIcon" :icon="btnMiddleIcon" class="mr-2" />
        {{ btnMiddle }}
      </button>
      ...
      >
        <Icon v-if="btnRightIcon" :icon="btnRightIcon" class="" />
        {{ btnRight }}
      </button>
    </div>
  </div>
